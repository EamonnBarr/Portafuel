        ...
        <div class="container">
          ...
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 ftco-animate text-center">
              ...
              <p></p>
              <p><a href="bookingform.html" class="btn btn-primary btn-outline-white px-4 py-3"> Order Now!</a></p>
            </div>
          </div>
        </div>
      </div>
...
echo "<table border='0'><tr><th>Our Customer Rating</th></tr>";
for($i=0; $i<=$num; $i++)
{
          ...
          <div class="row d-flex justify-content-center">
            <div class="col-md-10 text-center heading-section heading-section-white ftco-animate">
             <h2 class="h1 font-weight-bold">Sign up now to make your Orders Even Faster!</h2>
              ...
              <p><a href="bookingform.html" class="btn btn-primary btn-outline-white mt-3 py-3 px-4">Signup/Login</a></p>
            </div>
          </div>
        </div>
      </div>
...
We provide delivery to the users requested location. </p>
         ...
         <div class="col-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>Sign up to receive updates and new features!</p>
